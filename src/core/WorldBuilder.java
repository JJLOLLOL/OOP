...
public class WorldBuilder {
    ...
    protected List<NPCCharacter> buildNPCs(Map<String, Location> locationsMap) {
        ...
        TreeMap<Integer, Location> nicholasSchedule = new TreeMap<>();
        nicholasSchedule.put(900, park);
        nicholasSchedule.put(1500, gym);
        nicholasSchedule.put(2100, cafe);
        npcs.add(new NPCCharacter("Nicholas", 30, "Male", "A friendly local.", nicholasSchedule));

        TreeMap<Integer, Location> jiaJingSchedule = new TreeMap<>();
        jiaJingSchedule.put(800, library);
        jiaJingSchedule.put(1200, cafe);
        jiaJingSchedule.put(1800, gym);
        npcs.add(new NPCCharacter("Jia Jing", 25, "Female", "A busy student.", jiaJingSchedule));

        TreeMap<Integer, Location> maheshaSchedule = new TreeMap<>();
        maheshaSchedule.put(600, gym);
        maheshaSchedule.put(1400, library);
        maheshaSchedule.put(2200, park);
        npcs.add(new NPCCharacter("Mahesha", 40, "Male", "A frequent gym-goer.", maheshaSchedule));
